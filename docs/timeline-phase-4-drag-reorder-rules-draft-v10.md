# Timeline Phase 4 拖曳重排 / 多人協作 / 固定卡 / 未設時間規則草稿 v10

Date: 2026-06-29
Status: Full rules draft for next chat / updated after Phase 4.6 implementation + fixed/untimed normalization hotfix
...
1. 固定卡拖曳錨點邏輯已明確拆到 Phase 4.7；Phase 4.6 已只完成基本 timed drag auto-continuation。
...
6. Phase 4.6 已新增並套用 RPC migration 023；Phase 4.7 是否需要新增 RPC / migration 仍待實作前確認。
...
4.7 處理固定卡作為時間錨點，固定錨點只限 complete timed + is_fixed，允許其他卡跨過固定卡，塞得下給時間，塞不下轉未設定時間；
