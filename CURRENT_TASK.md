...
- Transportation-card computed styles confirmed a 1 px border, 4 px vertical padding, 13 px title, and an 18 px Lucide category icon. The transport-insert zone now preserves a 4 px resting card gap, triggers from 3 px inside both adjacent card edges, and expands to a centered 22 px gap. Its full-width ghost surface uses `rgba(255, 255, 255, .58)`, the Plus begins within 4 px of the visit time text, and the trailing-line center offset remains below 1 px.
