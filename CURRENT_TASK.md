...
- Expanded visit cards keep notes unchanged. Linked budget uses a 14 px / 500 `Wallet` heading without left padding, followed by a thin divider and content-width pale-green budget tag. The heading and tag share a row when space permits, while the divider and tag wrap together below at constrained widths.
